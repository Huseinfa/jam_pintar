...
@section('content')
            ...
            <div class="container">
                ...
                <div class="text-center mb-4">
                    <h1 class="title-pretest fw-bold text-dark">
                        Yuk mulai kenali pola belajarmu🙆‍♀️
                    </h1>

                    <p class="subtitle-pretest text-dark fw-medium">
                        Jawab pertanyaan di bawah ini sesuai kondisi kamu ya.
                    </p>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-md-10">
                        <div class="question-card">
                            {{-- Question Text --}}
                            <h2 class="question-text mb-4" id="questionText">
    ...
    <style>
        ...
        .question-text {
            font-weight: 635;
            /* middle point (semi-medium, paling ideal) */
            font-size: 1.2rem;
            line-height: 2rem;
        }
    ...
    <script>
        ...
        function renderAnswerOptions(question) {
            ...
            const isImageUrl = (str) => {
                ...
                return /\.(jpg|jpeg|png|gif|webp)$/i.test(str) || str.startsWith('/img/') || str.includes(
                    'unsplash.com') || str.startsWith('http');
            };
